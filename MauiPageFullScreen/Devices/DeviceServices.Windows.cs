...
internal class DeviceServices : IDeviceServices
{
    ...
    public AppWindow FullScreen()
    {
        ...
        var item = currentPage.GetParentWindow().Handler.PlatformView as MauiWinUIWindow ?? throw new InvalidOperationException($"{nameof(MauiWinUIWindow)} cannot be null");
